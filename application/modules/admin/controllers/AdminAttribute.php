...
class AdminAttribute extends MY_Controller
{
    ...
    public function attributes()
    {
        ...
        $data['jquery'] = 'admin/settings/attribute/js/attribute-js';
        $data['content'] = 'admin/settings/attribute/index';
...
//        print_r($_REQUEST);die;
        ...
        if ($checkAttributeName) {
            ...
            if ($recordId) {
                $data['attributes'] = $this->AdminAttribute_model->getAttributes();
                $this->load->view('admin/settings/attribute/services/attribute-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editAttribute()
    {
        ...
        if ($attribute) {
            ...
            $this->load->view('admin/settings/attribute/services/edit-attribute-model', $data);
        } else {
            echo -1;
        }
    }
    ...
    public function attributeValues()
    {
        ...
        $data['jquery'] = 'admin/settings/attribute-value/js/attribute-value-js';
        $data['content'] = 'admin/settings/attribute-value/index';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function saveAttributeValue()
    {
        ...
        if ($this->AdminAttribute_model->checkAttributeValueName($SubCatId, $AttributeValue)) {
            ...
            if ($recordId) {
                ...
                $this->load->view('admin/settings/attribute-value/services/attribute-value-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editAttributeValue()
    {
        ...
        if ($attributeValue) {
            ...
            $this->load->view('admin/settings/attribute-value/services/edit-attribute-value', $data);
        } else {
            echo -1;
        }
    }
...
//print_r($checkAttributeValueName);die;
    ...
    public function getColorPicker()
    {
        ...
        $this->load->view('admin/settings/attribute-value/services/color-picker', $data);
    }
