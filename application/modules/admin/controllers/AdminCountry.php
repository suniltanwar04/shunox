...
class AdminCountry extends MY_Controller
{
    ...
    public function categories()
    {
        ...
        $data['jquery'] = 'admin/settings/country/js/country-js';
        $data['content'] = 'admin/settings/country/index';
    ...
    public function saveCategory()
    {
        ...
        if ($checkcategoryName) {
            ...
            if ($recordId) {
                ...
                $this->load->view('admin/settings/country/services/country-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editCategories()
    {
        ...
        if ($category) {
            ...
            $this->load->view('admin/settings/country/services/edit-country', $data);
        } else {
            echo -1;
        }
    }
    ...
    public function subCategory()
    {
        ...
        $data['jquery'] = 'admin/settings/state/js/state-js';
        $data['content'] = 'admin/settings/state/index';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function saveSubCategory()
    {
        ...
        if ($checkSubcatName) {
            ...
            if ($recordId) {
                $data['SubCategories'] = $this->AdminCountry_model->getSubCategory();
                $this->load->view('admin/settings/state/services/state-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editSubCategory()
    {
        ...
        if ($subcategory) {
            ...
            $this->load->view('admin/settings/state/services/edit-state', $data);
        } else {
            echo -1;
        }
    }
    ...
    public function Product()
    {
        ...
        $data['jquery'] = 'admin/settings/city/js/city-js';
        $data['content'] = 'admin/settings/city/index';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function saveCity()
    {
        ...
        if ($checkCity) {
            ...
            if ($recordId) {
                ...
                $this->load->view('admin/settings/city/services/city-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editCity()
    {
        ...
        if ($city) {
            $data['city'] = $city;
            $this->load->view('admin/settings/city/services/edit-city', $data);
        } else {
            echo -1;
        }
    }
    ...
    public function localities()
    {
        ...
        $data['jquery'] = 'admin/settings/locality/js/locality-js';
        $data['content'] = 'admin/settings/locality/index';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function saveLocality()
    {
        ...
        if ($checkLocality) {
            ...
            if ($recordId) {
                $data['localities'] = $this->AdminCountry_model->getLocalities();
                $this->load->view('admin/settings/locality/services/locality-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editLocality()
    {
        ...
        if ($locality) {
            ...
            $this->load->view('admin/settings/locality/services/edit-locality', $data);
        } else {
            echo -1;
        }
    }
