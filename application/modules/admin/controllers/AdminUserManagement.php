...
//        print_r($data);die;
        $data['jquery'] = 'admin/user-management/js/user-management-js';
        $data['content'] = 'admin/user-management/index';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function enableDisableUsers(){
        ...
        if ($activate) {
            $data['UserManagements'] = $this->AdminUserManagement_model->getUserManagement();
            $this->load->view('admin/user-management/services/user-management-list', $data);
        } else {
            echo -1;
        }
    }
...
//        print_r($data);die;
    $data['jquery'] = 'admin/user-management/js/user-management-js';
    $data['content'] = 'admin/user-management/services/user-detail';
    echo Modules::run('template/adminTemplate', $data);
}
...
public function getUserEditById($id){
    ...
    $data['content'] = 'admin/user-management/services/user-edit';
    echo Modules::run('template/adminTemplate', $data);
}
public function getListUserWiseOrderProductById($id){
    ...
    $data['jquery'] = 'admin/user-management/js/user-management-js';
    $data['content'] = 'admin/user-management/services/list-user-wise-orders-product';
    echo Modules::run('template/adminTemplate', $data);
}
...
public function editPassword()
    {
        ...
        $data['user_id'] = $this->input->post('recordId');
            ...
            $this->load->view('admin/user-management/model/change-password', $data);
