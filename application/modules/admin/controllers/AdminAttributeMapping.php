...
class AdminAttributeMapping extends MY_Controller
{
    ...
    public function AttributeMapping(){
            ...
            $data['jquery'] = 'admin/settings/attribute-mapping/js/attribute-mapping-js';
            $data['content'] = 'admin/settings/attribute-mapping/index';
    ...
    public function saveAttributeMapping(){
        ...
        $Attributevalueid = $this->input->post('addAttributevalueid');
            ...
            if ($recordId) {
                $data['attributeMapping'] = $this->AdminAttributeMapping_Model->getAttributeMapping();
                $this->load->view('admin/settings/attribute-mapping/services/attribute-mapping-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editAttributeMapping(){
        ...
        if ($attributeMapping) {
            ...
            $this->load->view('admin/settings/attribute-mapping/services/edit-attribute-mapping', $data);
        } else {
            echo -1;
        }
