                        ...
                        <table id="row-list" class="table table-bordered table-striped custom-table-head">
                            ...
                            foreach ($becomedealers as $becomedealer) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo $this->config->item('admin_base_url') . 'view-become-detail-with-dealer-id/'.$becomedealer->id; ?>" class="fa fa-eye-slash" aria-hidden="true"></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="glyphicon glyphicon-trash" title="Delete" style="cursor: pointer;" id="<?php echo $becomedealer->id?>"></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="<?php echo $this->config->item('admin_base_url') . 'edit-become-detail-with-dealer-id/'.$becomedealer->id; ?>" style="cursor: pointer;" id="<?php echo $becomedealer->id?>"><i class="fa fa-edit"></i></a>
                                    </td>
                                    
                                    <td> <a href="<?php echo $this->config->item('admin_base_url') . 'view-users/'.$becomedealer->id; ?>">
