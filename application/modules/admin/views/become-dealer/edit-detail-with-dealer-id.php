...
<form  method="post" role="form" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url()?>admin/updatedealerdetails/<?php echo $becomedealers->id?>">	
