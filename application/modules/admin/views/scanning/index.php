<div class="content-wrapper">
                            ...
                            <tbody>
                                ...
                                foreach ($alllocations as $alllocation) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="btn btn-success" href="<?php echo site_url('admin/editLocation/'.$alllocation->Id); ?>"><i class="fa fa-edit"></i> Edit</a>  </td>
                                        <td>
    ...
    <?php $this->load->view('admin/scanning/model/add-scanning-model'); ?>
