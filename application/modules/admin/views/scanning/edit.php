...
<form action="<?php echo $this->config->item('admin_base_url') . 'updateLocation/'.$location->Id; ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">	
