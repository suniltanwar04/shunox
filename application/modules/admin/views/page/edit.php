...
<a class="btn btn-primary" href="<?php echo site_url('admin/pagelist'); ?>"><i class="fa fa-backward"></i> Page</a>
<ol class="breadcrumb">
...
<form action="<?php echo site_url('admin/updatePage/'.$page->id); ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">	
<div class="box-body">
