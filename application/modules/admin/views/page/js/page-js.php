    ...
    $(document).off('click', '#savePage').on('click', '#savePage', function (e) {
        ...
        if (!page) {
            ...
            $.ajax({
                ...
                contentType: false,
                processData: false,
                url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/savePage",
                success: function (result) {
                    ...
                    if (result == -1) {
                      ...
                      // window.location.href = $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/pagelist";
                    }
                },
    ...
    $(document).off('click', '#editPage').on('click', '#editPage', function (e) {
        ...
        if (recordId) {
            ...
            $.ajax({
                ...
                url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/editPage",
                success: function (result) {
                    $('#loading').css("display", "none");
                    if (result == -1) {
    ...
    $(document).off('click', '#updateCategory').on('click', '#updateCategory', function (e) {
        ...
        if (!editCategoryName) {
            ...
            $.ajax({
                ...
                url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/updatecategory",
                success: function (result) {
        ...
        bootbox.confirm("Are you sure to disable this record?", function (result) {
            if (result == true) {
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/enableDisableCategory",
                    success: function (result) {
//                        location.reload();
                        if (result == -1) {
