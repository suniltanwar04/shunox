        ...
        $(document).off('click', '#saveAttributeMapping').on('click', '#saveAttributeMapping', function (e) {
            ...
            if (!addProductId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/saveAttributeMapping",
        ...
        $(document).off('click', '.edit').on('click', '.edit', function (e) {
            ...
            if (recordId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/editAttributeMapping",
                    success: function (result) {
//                        console.log(result);return false;
                        $('#loading').css("display", "none");
        ...
        $(document).off('click', '#updateAttributeMapping').on('click', '#updateAttributeMapping', function (e) {
            ...
            if (!editProductId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/updateAttributeMapping",
                    success: function (result) {
                        $('#loading').css("display", "none");
//                        console.log(result);
//                        return false;
            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/enableDisableAttributeMapping",
                        success: function (result) {
