        ...
        $(document).off('click', '#saveCategory').on('click', '#saveCategory', function (e) {
            ...
            if (!addAttributeName) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/saveAttribute",
        ...
        $(document).off('click', '.edit').on('click', '.edit', function (e) {
            ...
            if (recordId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/editAttribute",
                    success: function (result) {
        ...
        $(document).off('click', '#updateAttribute').on('click', '#updateAttribute', function (e) {
            ...
            if (!editAttributeName) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/updateAttribute",
                    success: function (result) {
            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/enableDisableAttribute",
                        success: function (result) {
                            location.reload();
                            if (result == -1) {
