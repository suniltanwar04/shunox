...
<div class="modal fade" id="editCityModal" tabindex="-1" role="dialog" aria-labelledby="editCityModalLabel"
    ...
    <div class="modal-dialog " role="document" style="width: 55%">
        ...
        <form class="form-horizontal" id="productAttreditForm">

            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="addCityModalLabel">edit Product Attribute</h4>
                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type='hidden' name='SubCategoryId'
                                                         value='<?php echo $attributes_vals[0]->SubCategoryId;  ?>' id="SubCategoryId">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-medium btn-primary" id="updateProductAttr">Update</a>
                </div>
            </div>
        </form>
    </div>
