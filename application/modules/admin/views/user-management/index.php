...
-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo $this->config->item('admin_base_url') . 'user-details/'.$UserManagement->Id; ?>" class="fa fa-eye-slash" aria-hidden="true"></a>
                                             ...
                                             &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="<?php echo $this->config->item('admin_base_url') . 'user-edit/'.$UserManagement->Id; ?>" aria-hidden="true"><i  class="fa fa-edit"></i></a>
    ...
    <?php $this->load->view('admin/user-management/model/change-password'); ?>
  <?php  $this->load->view('admin/user-management/model/change-password');?>
