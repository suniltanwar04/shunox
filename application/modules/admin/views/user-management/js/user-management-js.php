            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/enable-disable-users",
            ...
            bootbox.confirm("Are you sure want to delete this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/delete-user",
                        success: function (result) {
//console.log(result);return false;
...
//
//                        },
//                        url: $('#baseUrl').val() + "<?php //echo CommonConstants::ADMIN_URL_SLUG;?>///list-user-wise-orders",
//                        success: function (result) {
////console.log(result);return false;
//                            $('#loading').css("display", "none");
//                            if (result == -1) {
           ...
           if($('#newPasss').val()==''){
               ...
               $.ajax({
                 type : 'POST',
                   ...
                   url : '<?php echo base_url()?>admin/userPasswordUpdate',
                   success : function(result){
                    if(result == 1){
