        ...
        $('#login').on('click', function () {
            ...
            if (email == '') {
                ...
                $.ajax({
                    ...
                    url: baseUrl + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/login",
                    success: function (result) {
                        ...
                        if (result == -1) {
                            ...
                            if (result == 1) {
                                window.location.href = baseUrl + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/dashboard";
                            } else {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result == -1) {
                                ...
                                if (result == 1) {
                                    window.location.href = baseUrl + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/product";
                                } else {
                                    $("#errorDisplay").html("<div class='alert alert-danger alert-dismissible' style='text-align: center;'>Unauthorised Access.</div>");
                                }
                            } else {
...
//                url: baseUrl + "admin/AdminLogin/sendResetPassMail",
                    url: baseUrl + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/send-forgot-pass-mail",
                    success: function (result) {
//                    console.log((result));
//                    return false;
                        if (result == 1) {
...
//                url: baseUrl + "admin/AdminLogin/resetPasswordByHash",
                    url: baseUrl + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/resetpassword",
                    success: function (result) {
                        console.log(result);
                        //return false;
                        if (result == 1) {
