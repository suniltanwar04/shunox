            ...
            if(status1 === true && status2 === true){
                ...
                var formData = new FormData($("#socialAddForm")[0]);
                    $.ajax({
                        ...
                        contentType: false,
                        processData: false,
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/saveSocial",
            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/enableDisableSocial",
                        success: function (result) {
                            $('#loading').css("display", "none");
//                        console.log(result);
//                        return false;
            ...
            bootbox.confirm("Are you sure want to delete this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::ADMIN_URL_SLUG;?>/deleteSocial",
                        success: function (result) {
