<script>
    $(document).ready(function () {
        ...
        $(document).off('click', '.coupondetail').on('click', '.coupondetail', function (e) {
            ...
            $.ajax({
                ...
                url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/coupon-listing",
        ...
        $(document).off('change', '#currentstatusId').on('change', '#currentstatusId', function (e) {
            ...
            var recordId = res[1];
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/current-status",
                    success: function (result) {
                      $('#loading').css("display", "none");
  ...
  $('#loading').css("display", "block");
            $.ajax({
                ...
                url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/getstatusbyorder",
                success: function (result) {
//console.log(result);return false;
                    $('#loading').css("display", "none");
                    if (result == -1) {
            ...
            bootbox.confirm("Are you sure want to delete this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/delete-order-management",
                        success: function (result) {
