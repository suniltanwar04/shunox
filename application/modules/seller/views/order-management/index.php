...
//                                    $isActive = CommonHelpers::getStatus($OrderManagement->IsActive);
                        ...
                        data-target='#addOrderModal'>Coupon Detail
                                       ...
                                       <!-- <td><?php /* if($OrderManagement->IsPaid == 1){
                                        ...
                                        <td> <a href="<?php echo $this->config->item('seller_base_url') . 'user-details/'.$OrderManagement->UserId; ?>" class="fa fa-eye-slash" aria-hidden="true"></a></td>
                                        <?php }else{?>
                                        <td> Guest Users</td>
                                        <?php }?>

                                           <td> <a href="<?php echo $this->config->item('seller_base_url') . 'order-wise-product-details/'.$OrderManagement->OrderHash; ?>" class="fa fa-eye-slash" aria-hidden="true"></a>
                                           &nbsp;&nbsp;&nbsp;&nbsp;
...
<!--    --><?php //$this->load->view('seller/order-management/services/order-wise-product-details-coupon'); ?>
