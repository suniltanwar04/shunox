        ...
        $(document).off('click', '#saveAttributeValue').on('click', '#saveAttributeValue', function (e) {
            ...
            if (!addSubCatId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/saveAttributeValue",
        ...
        $(document).off('click', '.edit').on('click', '.edit', function (e) {
            ...
            if (recordId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/editAttributeValue",
                    success: function (result) {
//                        console.log(result);return false;
                        $('#loading').css("display", "none");
        ...
        $(document).off('click', '#updateAttributeValue').on('click', '#updateAttributeValue', function (e) {
            ...
            if (!editSubCatValueId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/updateAttributeValue",
                    success: function (result) {
                        $('#loading').css("display", "none");
//                        console.log(result);
//                        return false;
            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/enableDisableAttributeValue",
                        success: function (result) {
...
//                },
//                url: $('#baseUrl').val() + "<?php //echo CommonConstants::SELLER_URL_SLUG;?>///color-picker-input",
//                success: function (result) {
////                    console.log(result);
////                    return false;
