        ...
        <h1>
            ...
            <div class="btn-group pull-right">
                <button id="addAttribute" class="btn btn-medium btn-primary" data-toggle="modal"
                        data-target="#addCategoryModal">Add Attribute Value
                </button>
            </div>
        </h1>
    </section>
...
//                               echo "<pre>"; print_r($attributes);die;
                                ...
                                foreach ($attributes as $attribute) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $attribute->SubCategoryName; ?></td>

                                            <td><?php echo $attribute->AttributeValue; ?></td>
    ...
    <?php $this->load->view('seller/settings/attribute-value/model/add-attribute-value-model'); ?>
