    ...
    <form class="form-horizontal" id="categoryEditForm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="editCountryModalLabel">Edit Category</h4>
            </div>
                                        ...
                                        <div class="box-body" id="formBody">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <span id="editCategoryNameError" style="color: red;"></span>
                                                </div>
                                            </div>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-medium btn-primary"  data-dismiss="modal" id="updateCategory">Update</a>
            </div>
        </div>
    </form>
</div>
