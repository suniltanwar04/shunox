        ...
        $(document).off('click', '#saveSubCategory').on('click', '#saveSubCategory', function (e) {
            ...
            if (!addCatId) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/saveSubCategory",
        ...
        $(document).off('click', '.edit').on('click', '.edit', function (e) {
            ...
            if (recordId) {
                ...
                $.ajax({
                    ...
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/editSubCategory",
                    success: function (result) {
                        $('#loading').css("display", "none");
//                    console.log(result);
//                    return false;
        ...
        $(document).off('click', '#updateSubCat').on('click', '#updateSubCat', function (e) {
            ...
            if (!editcatId) {
                ...
                $.ajax({
                    ...
                    processData:false,
                    cache:false,
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/updateSubCategory",
                    success: function (result) {
                        $('#loading').css("display", "none");
                        // console.log(result);
                        // return false;
            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/enableDisableSubCat",
                        success: function (result) {
