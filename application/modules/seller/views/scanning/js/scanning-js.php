           ...
           if (!addCompany){
            ...
            if(addState==''){
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/saveLocation",
            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/enableDisableLocation",
                        success: function (result) {
                            $('#loading').css("display", "none");
//                        console.log(result);
//                        return false;
            ...
            bootbox.confirm("Are you sure want to delete this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/deleteLocation",
                        success: function (result) {
