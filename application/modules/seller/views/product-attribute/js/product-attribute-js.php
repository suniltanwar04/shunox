...
//                    alert(pageIndex);
        ...
        $(document).off('change', '#ProductsAttr').on('change', '#ProductsAttr', function(){
            ...
            $.ajax({
                url: "<?php echo base_url().CommonConstants::SELLER_URL_SLUG;?>/AdminProduct/getAttributeVals",
                type:'post',
            ...
            if(attr == ""){
              ...
              $("#discountPriceError").text('Discount Price Can\'t be more than price !');
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: "<?php echo base_url().CommonConstants::SELLER_URL_SLUG;?>/saveProductAttr",
                    success: function (result){
                        if(result == 1){
		 ...
		 $(document).off('click', '#saveImageAttr').on('click', '#saveImageAttr', function (e) {
            ...
            var message = $("#ImageInsertionResult");
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: "<?php echo base_url().CommonConstants::SELLER_URL_SLUG;?>/saveImageAttr",
                    success: function (result){
						console.log(result);
                        if(result == "success"){
...
//                ("#addProductImageError").show().html('Please Select image.');
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/saveProduct",
                    success: function (result) {
        ...
        $(document).off('click', '#updateProduct').on('click', '#updateProduct', function (e) {
            ...
            if (!editCategoryId) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    processData: false,
                    url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/updateProduct",
                    success: function (result) {
//                    console.log(result);
//                    return false;
                        $('#loading').css("display", "none");
            ...
            bootbox.confirm("Are you sure to disable this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/enableDisableProduct",
                        success: function (result) {
                            $('#loading').css("display", "none");
//                        console.log(result);
//                        return false;
        ...
        $(document).off('change', '#addCategoryId').on('change', '#addCategoryId', function (e) {
            ...
            $.ajax({
                ...
                url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/getSubCategoryByCategory",
                success: function (result) {
            ...
            bootbox.confirm("Are you sure want to delete this record?", function (result) {
                if (result == true) {
                    ...
                    $.ajax({
                        ...
                        url: $('#baseUrl').val() + "<?php echo CommonConstants::SELLER_URL_SLUG;?>/deleteProduct",
                        success: function (result) {
        ...
        $(".editablePrice").on('blur', function(){
          ...
          $("#loading").fadeIn(200);
          $.ajax({
            url: "<?php echo base_url().CommonConstants::SELLER_URL_SLUG;?>/AdminProduct/updateAttributePrice",
              type:"POST",
