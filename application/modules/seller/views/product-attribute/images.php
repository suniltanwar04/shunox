...
<div class="content-wrapper">
    ...
    <?php $this->load->view('seller/product-attribute/model/add-product-attribute-model'); ?>
    <?php $this->load->view('seller/product-attribute/model/add-product-image-model'); ?>
