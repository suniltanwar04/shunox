...
<form action="<?php echo $this->config->item('seller_base_url') . 'updatebanner/'.$banner['id'].''; ?>" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">	
...
<div class="active tab-pane" id="setting">
	<div class="box-body">
		...
		<input type="hidden" name="old_userfile" value="<?php echo base_url(); ?>uploads/banner/<?php echo $banner['image']?>">			
		</div>
		</div>	
		...
		<div class="col-sm-5">
		<?php if($banner['image']){ ?>	
		<img src="<?php echo base_url(); ?>uploads/banner/<?php echo $banner['image']?>" width="105" style="border: 2px solid #6AC4EC;border-radius: 2px;">
		<?php }else{?>	
