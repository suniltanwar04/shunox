...
class AdminProduct extends MY_Controller
{
    ...
    public function productAttributeList($productId){
        ...
        $data['jquery'] = 'seller/product-attribute/js/product-attribute-js';
        $data['content'] = 'seller/product-attribute/index';
	...
	public function productImagesList($productId){
        ...
        // $data['attributes'] = $this->AdminAttribute_model->getAttributes();
        $data['jquery'] = 'seller/product-attribute/js/product-attribute-js';
        $data['content'] = 'seller/product-attribute/images';
        echo Modules::run('template/adminTemplate', $data);
    ...
    public function products(){
        ...
        $data['jquery'] = 'seller/product/js/product-js';
        $data['content'] = 'seller/product/index';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function enableDisableProduct()
    {
        ...
        if ($activate) {
            $data['products'] = $this->AdminProduct_model->getProduct();
            $this->load->view('seller/product/services/product-list', $data);
        } else {
            echo -1;
        }
    }
    ...
    public function editProduct($productId){
        ...
        // echo "</pre>";
        // die;
        $data['content'] = 'seller/product/edit-product';
        echo Modules::run('template/adminTemplate', $data);
    }
