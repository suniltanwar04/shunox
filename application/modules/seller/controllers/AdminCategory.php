...
class AdminCategory extends MY_Controller
{
    ...
    public function categories()
    {
        ...
        //print_r($data['categories']);
         //die;
        $data['jquery'] = 'seller/settings/category/js/category-js';
        $data['content'] = 'seller/settings/category/index';
    ...
    public function saveCategory()
    {
        ...
        if ($checkCategoryName) {
            ...
            if ($recordId) {
                $data['categories'] = $this->AdminCategory_model->getCategories();
                $this->load->view('seller/settings/category/services/category-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editCategories()
    {
        ...
        if ($category) {
            ...
            $this->load->view('seller/settings/category/services/edit-category-model', $data);
        } else {
            echo -1;
        }
    }
    ...
    public function subCategories()
    {
        ...
        $data['jquery'] = 'seller/settings/sub-category/js/sub-category-js';
        $data['content'] = 'seller/settings/sub-category/index';
        echo Modules::run('template/adminTemplate', $data);
    }
...
//                        echo "The file " . basename($_FILES['addimage']['name'][$i]) . " has been uploaded";
        ...
        if ($checkSubcatName) {
            ...
            if ($recordId) {
                $data['SubCategories'] = $this->AdminCategory_model->getSubCategory();
                $this->load->view('seller/settings/sub-category/services/sub-category-list', $data);
            } else {
                echo -2;
            }
    ...
    public function editSubCategory()
    {
        ...
        if ($subcategory) {
            ...
            $this->load->view('seller/settings/sub-category/services/edit-sub-category', $data);
        } else {
            echo -1;
        }
    }
