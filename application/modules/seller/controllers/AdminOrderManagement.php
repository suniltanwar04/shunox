...
class AdminOrderManagement extends MY_Controller
{
    ...
    public function orderManagement(){
        ...
        //die;
        $data['jquery'] = 'seller/order-management/js/order-management-js';
        $data['content'] = 'seller/order-management/index';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function orderCouponListing(){
        ...
        if ($data) {
            ...
            $this->load->view('seller/order-management/services/order-wise-product-details-coupon', $data);
        } else {
            echo -1;
        }
    }
    ...
    public function orderWiseProductDetails($id){
        ...
        $data['jquery'] = 'seller/order-management/js/order-management-js';
        $data['content'] = 'seller/order-management/services/order-wise-product-details';
        echo Modules::run('template/adminTemplate', $data);
    }
    ...
    public function currentStatus(){
     ...
     public function getStatusByOrder(){
        ...
        $this->load->view('seller/order-management/services/order-list', $data);
    }
