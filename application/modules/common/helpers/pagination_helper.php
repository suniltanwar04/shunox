...
class Pagination{
    ...
    function createLinks(){
        ...
        if ($numPages == 1){
            if ($this->showCount){
                $info = '<div class="pull-right">Showing : ' . $this->totalRows.' to ' . $this->totalRows.' of ' . $this->totalRows.'</div>';
                return $info;
            }else{
                return '';
            }
    ...
    function getAJAXlink( $count, $text) {
        ...
        $localityIds    = $this->localityIds;
        $specialityIds    = $this->specialityIds;
        $experienceIds    = $this->experienceIds;
        $equipmentSubCatIds    = $this->equipmentSubCatIds;
        $searchKeyword    = $this->searchKeyword;
        $this->additionalParam = "{'page' : $pageCount,'localityIds' : '$localityIds','specialityIds' : '$specialityIds','experienceIds' : '$experienceIds','equipmentSubCatIds':'$equipmentSubCatIds','searchKeyword':'$searchKeyword'}";
